      ...
      <footer className="py-12 bg-indigo-950">
        <div className="container px-4 mx-auto">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
            <div>
              <h3 className="mb-4 text-xl font-bold text-white">Conclave</h3>
              <p className="text-indigo-300">
                The next generation of communication, designed for modern teams and individuals.
              </p>
            </div>
          ...
          <div className="pt-8 mt-8 border-t border-indigo-900">
            <div className="flex flex-col items-center justify-between space-y-4 md:flex-row md:space-y-0">
              <p className="text-indigo-400">© {new Date().getFullYear()} Conclave. All rights reserved.</p>
